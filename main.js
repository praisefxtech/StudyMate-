...
if(aiChat && aiChat.classList.contains("aiFullscreen")){

    aiChat.classList.remove("aiFullscreen");
...
const chats =
JSON.parse(localStorage.getItem("studyMateChats")||"[]");
...
chat.classList.toggle("aiFullscreen");
...
<button onclick="copyAI(this)">
📋
</button>

<button onclick="speakAI(this)">
🔊
</button>

<button onclick="saveAI(this)">
❤️
</button>

<button onclick="rateAI(this,'up')">
👍
</button>

<button onclick="rateAI(this,'down')">
👎
</button>
...
loading.className="aiMessage bot";

loading.innerHTML = `

<div class="bubble aiThinking">
...
let saved =
JSON.parse(localStorage.getItem("savedAI") || "[]");
...
<div class="aiMessage bot">

<div class="bubble">

👋 Welcome to <b>StudyMate AI</b>.
...
let chats =
JSON.parse(
localStorage.getItem("studyMateChats") || "[]"
);
...
onclick="event.stopPropagation(); togglePin(${chat.id})"
...
document
.querySelectorAll(".aiModes button")
.forEach(btn=>{
...
alert("Voice input isn't supported on this browser.\n\nPlease use Google Chrome or install StudyMate as a PWA.");
...
message =
"🎤 Microphone permission was denied.\n\nPlease allow microphone access in your browser or app settings and try again.";
...
if(document.getElementById("aiQuestion").value.trim()){
